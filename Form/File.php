...
/**
 * Makes a file upload control.
 * @package Tiramisu
 * @subpackage Forms
 */
class Tm_Form_File extends Tm_Form_ElementAbstract
{
	/**
	...
	public function makeElement()
	{
		...
		$max_bytes = return_bytes(ini_get('upload_max_filesize'));
		$out = "<input type='hidden' name='MAX_FILE_SIZE' value='{$max_bytes}' />\n";
		$out .= "<input type='file' name='{$this->name}' id='{$id}' class='{$class}'";
