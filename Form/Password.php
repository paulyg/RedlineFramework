 ...
 * @subpackage Forms
 */
class Tm_Form_Password extends Tm_Form_ElementAbstract
{
	/**
	...
	/**
	 * Build the password form element.
	 * @return string
	 */
	public function makeElement()
	{
		...
		$out = "<input type='password' name='{$this->name}' id='{$id}' class='{$class}' value='{$value}'";
